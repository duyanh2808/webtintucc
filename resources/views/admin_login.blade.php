        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-auth">
              ...
              ?>
              <div class="card-body">
                <form method="POST" action="{{URL::to('/admin-index')}}" class="needs-validation" novalidate="">
                  {{ csrf_field() }}
                ...
                <div class="text-center mt-4 mb-3">
                  <a href="/login-auth"> <div class="text-job text-muted">Đăng nhập Admin</div></a>
                </div>
                <div class="text-center mt-4 mb-3">
                  <a href="/register-auth"> <div class="text-job text-muted">Đăng Ký </div></a>
                </div>
