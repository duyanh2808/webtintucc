...
<head>
  ...
  <title>Đăng Ký Admin Auth</title>
  <!-- General CSS Files -->
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-auth">
              ...
              ?>
              <div class="card-body">
                <form method="POST" action="{{URL::to('/register')}}" class="needs-validation" enctype="multipart/form-data">
                  {{ csrf_field() }}
                ...
                <div class="form-check form-check-inline">
                  ...
                  <div class="form-group">
                    <div class="d-block">
                      <label for="password" class="control-label">Ảnh</label>                    
                    </div>
                    <input id="img" type="file" class="form-control" name="admin_img"  required>
                    {{-- <div class="invalid-feedback">
                      please fill in your password
                    </div> --}}
                  </div>
                  ...
                  <div class="text-center mt-4 mb-3">
                    <a href="/login-auth"> <div class="text-job text-muted">Đăng nhập Auth</div></a>
                  </div>
                {{-- <div class="text-center mt-4 mb-3">
