                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a onclick="return confirm('bạn có muốn xóa không?')" href="{{URL::to('/detele-loaitin/'.$lt->Ma_Loai)}}"><button type="button" class="btn btn-secondary"><i class="bi bi-trash"></i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
