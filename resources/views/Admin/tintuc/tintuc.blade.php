          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-header">
                <a href="{{URL::to('/themtintuc')}}"><button type="button" class="btn btn-info"><i class="bi bi-plus-square"></i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 16 16">
                ...
                <div class="table-responsive">
                  <table id="mainTable" class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{$tt->Ma_Tin_Tuc}}</td>
                        <td><a href="{{URL::to('/chi-tiet-tintuc/'.$tt->Ma_Tin_Tuc,Str::slug($tt->Tieu_De))}}">{{$tt->Tieu_De}}</a></td>
                        <td>{{$tt->Tom_Tat}}</td>
                        <td>{!!substr($tt->Noi_Dung,0,200)!!}...</td>
                        <td>{{$tt->Ma_Loai}}</td>
                        <td>{!!substr($tt->Tu_Khoa,0,200)!!}...</td>
                        <td><img width="100px" height="100px" src="assets/anh/tintuc/{{$tt->anh_tintuc}}" alt=""></td>
                        <td>{{$tt->Luot_Xem}}</td>
                        <td>{{$tt->admin_id}}</td>
                        <td>{{$tt->ngay_dang}}</td>
                        <td>{{$tt->tag}}</td>
