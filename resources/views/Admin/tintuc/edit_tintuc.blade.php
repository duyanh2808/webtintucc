...
<div class="row">
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
      @foreach ($Edit_tin as $key=>$et)
          
     
        <form action="{{URL::to('/update-tin/'.$et->Ma_Loai) }}" method="post" enctype="multipart/form-data"> 
          {{ csrf_field() }}
        ...
        <div class="form-group row mb-4">
          ...
          <div class="col-sm-12 col-md-7">
            <input type="text" class="form-control" name="Tu_khoa" value="{{$et->Tu_Khoa}}">
          </div>
        </div>
        <div class="form-group row mb-4">
