          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-header">
                <a href="{{URL::to('/them-mentor')}}"><button type="button" class="btn btn-info"><i class="bi bi-plus-square"></i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 16 16">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id="mainTable" class="table table-striped">
                    ...
                    <tbody>
                        @foreach($showmentor as $key => $sm)
                      <tr>
                        <td>{{$sm->Ma_mentor}}</td>
                        <td>{{$sm->Ten_mentor}}</td>
                        <td>{{$sm->Chuc_vu}}</td>                     
                        <td><img width="100px" height="100px" src="assets/anh/mentor/{{$sm->anh_mentor}}" alt=""></td>
                        <td>{{$sm->gioi_thieu}}</td>
                       
                        <td>
                          <a href="{{URL::to('/edit-mentor/'.$sm->Ma_mentor)}}"><button type="button" class="btn btn-warning"><i class="bi bi-pencil-square"></i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                          </svg></button></a>
                          <a onclick="return confirm('bạn có muốn xóa không?')" href="{{URL::to('/delete-mentor/'.$sm->Ma_mentor)}}"><button type="button" class="btn btn-secondary"><i class="bi bi-trash"></i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
