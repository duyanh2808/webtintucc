        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-8">
                    <div class="row mb-30">
                        @foreach ($tintuc_tag as  $ll)
                            
                        
                        <div class="col-xl-4 col-lg-6 col-md-6 mb-25">
                            <div class="postbox">
                                <div class="post-img">
                                    <a href="{{URL::to('/chi-tiet-tintuc/'.$ll->Ma_Tin_Tuc)}}"><img height="200" width="200" src="{{URL::to('assets/anh/tintuc')}}/{{$ll->anh_tintuc}}" alt=""></a>
                                </div>
                                ...
                                <div class="hero-post-item hero-post-item-2">
                                    ...
                                    <div class="post-sm-list fix mb-20">
                                        <div class="post-sm-img f-left">
                                            <a href="{{URL::to('/chi-tiet-tintuc/'.$xn->Ma_Tin_Tuc)}}"><img height="50" width="50" src="{{URL::to('assets/anh/tintuc')}}/{{$xn->anh_tintuc}}" alt=""></a>
                                        </div>
                                        <div class="post-2-content fix">
                                            ...
                                            <h4><a href="{{URL::to('/chi-tiet-tintuc/'.$xn->Ma_Tin_Tuc)}}">{!! $xn->Tieu_De !!}</a></h4>
                                        </div>
                                    </div>
                                    @endforeach
